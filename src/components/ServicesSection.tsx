...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    <motion.div
      className="group relative overflow-hidden rounded-2xl border border-border bg-card/50 backdrop-blur-sm transition-all duration-300 hover:border-primary/40"
    ...
    >
      ...
      <div className="p-6">
        ...
        <h3 className="font-display font-bold mb-3 text-foreground group-hover:text-primary transition-colors text-xl">
          {service.title}
        </h3>
...
const ServicesSection = () => {
  return (
    <section id="services" className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="absolute top-20 left-10 h-72 w-72 rounded-full bg-primary/5 blur-[90px]" />
      <div className="absolute bottom-20 right-10 h-96 w-96 rounded-full bg-accent/5 blur-[110px]" />
      ...
      <div className="relative z-10 px-6 lg:px-12 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg font-body mt-6">
            Real-world platforms, dashboards, real-time systems, authentication,
            secure payments and performance-first applications.
          </p>
        </motion.div>
